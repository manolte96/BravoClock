		...
		<div id='Container'>
			<div id='Rules'>
				...
				<div className='instructions'>
					<h3 id='mobile-h3'> EACH PLAYER  <span id='player-rounds-span'>1 ROUND MINIMUM <br/> 3 ROUNDS MAXIMUM </span></h3>
					<h3 id='desktop-h3'> EACH PLAYER - 1 ROUND MINIMUM / 3 ROUNDS MAXIMUM </h3>
					<p>The referee will award the choice of offense or defense to the player that was closest to submitting the other during regulation. Attacking player may choose an Armbar or Back Control. <br>
					</br>
					The player who attacks first will be considered the Red Player, and the player that defends first will be considered the Blue Player.<br>
					</br>
					If Red is able to submit Blue, Blue must submit Red in less time than they were subbed in order to win. If no subs are achieved, the player with the quickest escape time will be called the winner. <br>
					</br>
					</p>		
				</div>			
			</div>
